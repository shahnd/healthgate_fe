export default function Sidebar() {
    ...
    <div className="w-52 h-screen bg-slate-800 text-white p-5">
      ...
      <nav className="flex flex-col gap-2">
        ...
        <a href="#settings" className="block py-2 px-3 hover:bg-slate-700 rounded transition">병원 관리</a>
        <a href="#settings" className="block py-2 px-3 hover:bg-slate-700 rounded transition">공지사항</a>
