    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <div className="sidebar-menu">
          ...
          >
            <svg className="sidebar-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
        ...
        <div className="sidebar-menu">
          ...
          <div>
            ...
            >
              ...
              <span>보건 상담</span>
              <span className={`submenu-arrow ${openMenus.consultation ? "open" : ""}`}>
                ▼
              </span>
            </button>

            <div className={`sidebar-submenu-wrapper ${openMenus.consultation ? "open" : ""}`}>
              <ul className="sidebar-submenu">
                <li><NavLink to="/consultation/reservation/list">상담 예약 조회</NavLink></li>
                <li><NavLink to="/consultation/reservation">상담 예약 신청</NavLink></li>
                <li><NavLink to="/consultation/list">상담 내역 조회</NavLink></li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            >
              ...
              <span>건강검진 관리</span>
              <span className={`submenu-arrow ${openMenus.checkups ? "open" : ""}`}>
                ▼
              </span>
            </button>
          ...
          <div>
            ...
            >
              ...
              <span>병원 관리</span>
              <span className={`submenu-arrow ${openMenus.hospitals ? "open" : ""}`}>
                ▼
              </span>
            </button>
        ...
        <div className="sidebar-menu">
          <div>
            ...
            >
              ...
              <span>공지사항</span>
              <span className={`submenu-arrow ${openMenus.notices ? "open" : ""}`}>
                ▼
              </span>
            </button>
          ...
          <div>
            ...
            >
              ...
              <span>직원 관리</span>
              <span className={`submenu-arrow ${openMenus.employees ? "open" : ""}`}>
                ▼
              </span>
            </button>

            <div className={`sidebar-submenu-wrapper ${openMenus.employees ? "open" : ""}`}>
              <ul className="sidebar-submenu">
                <li><NavLink to="/employees">직원 조회</NavLink></li>
                <li><NavLink to="/employees/new">직원 등록</NavLink></li>
              </ul>
            </div>
          </div>
          ...
          >
            <svg className="sidebar-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
              <path strokeLinecap="round" strokeLinejoin="round" d="M10.3 3.2l.7-1.2h2l.7 1.2 1.5.6 1.3-.5 1.4 1.4-.5 1.3.6 1.5 1.2.7v2l-1.2.7-.6 1.5.5 1.3-1.4 1.4-1.3-.5-1.5.6-.7 1.2h-2l-.7-1.2-1.5-.6-1.3.5-1.4-1.4.5-1.3-.6-1.5-1.2-.7v-2l1.2-.7.6-1.5-.5-1.3L6.8 3.3l1.3.5 1.5-.6z" />
