...
export default function Sidebar() {
  ...
  const handleLogout = () => {
    ...
    return (
      <aside
      className="
        sticky top-0 h-screen w-52 shrink-0
        self-start overflow-y-auto
        bg-slate-800 p-5 text-white
      "
    >
    <div className="w-52 h-screen bg-slate-800 text-white p-5">
      ...
      <nav className="flex flex-col gap-2">
        ...
        <a href="/checkup/list" className="block py-2 px-3 hover:bg-slate-700 rounded transition">건강검진</a>
